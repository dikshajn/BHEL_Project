...
<head>
    ...
    <title>Maintainance Operation_BHEL</title>
</head>
<body>
    ...
    <!-- About Maintainance Operation Section -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card border-0 shadow-lg">
                        <div class="card-body">
                            <h3 class="text-center mb-4">About Maintainance Operation</h3>
                            <p class="text-justify">
                                Welcome to the Maintainance Operation of Bharat Heavy Electricals Ltd. (BHEL). Our system is designed to streamline the management of maintenance requests and scheduling for power plant equipments, ensuring smooth operations and minimal downtime.
                                For administrators, Maintainance Operation provides robust tools to oversee and manage maintenance tasks effectively. They can review and approve requests, assign tasks to technicians, and monitor progress in real-time. Comprehensive reporting features offer valuable insights for informed decision-making and process optimization.
                                ...
                                With Maintainance Operation, BHEL continues its commitment to powering progress and improving lives by maintaining the reliability and efficiency of critical power plant equipment. Join us in advancing operational excellence with Maintainance Operation.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- End About Maintainance Operation Section -->
                ...
                <div class="col-lg-3 col-sm-6"> 
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Power Plant workers submit a maintenance request via the Maintainance Operation portal of BHEL.</p>
                        </div>
                    </div>
                </div>
                <!-- Ending First Column -->
        ...
        <div class="container">
            ...
            <div class="row py-3">
                ...
                <div class="col-md-6 text-right">
                    <small> Designed by Diksha Jain &copy; 2024.</small>
